...
import { Camera, ChevronLeft, ChevronRight, MousePointer2, RadioTower } from 'lucide-react';
...
import { formatAnalysisSource, formatCount, formatDateTime, formatDuration, formatRelativeTime } from '../lib/format';
import { useDebouncedValue } from '../lib/use-debounced-value';
import type { AdminAnalysesQuery, AdminAnalysesResponse, AdminAnalysis, AnalysisSource, AnalysisStatus } from '../types';
...
export function AnalysesPage({
  ...
  }, [currentPage, debouncedQuery, onQueryChange, source, status]);
  useEffect(() => {
  ...
  return (
    <div className="page-stack">
      ...
      <Panel className="table-panel">
        ...
        ) : <EmptyState title="Проверок не найдено" text={query || status !== 'all' || source !== 'all' ? 'Измените фильтры или запрос.' : 'В базе пока нет анализов.'} />}
